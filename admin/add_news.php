...
//    $sql = "insert into news set title = '$title',category_id = '$id_cate', description ='$desc', image='$dst_db',featured='$featured',active='$active',date_news='$date_news'";
//    $res = mysqli_query($conn, $sql);
    $sql=$conn->prepare("insert into news set title = ?,category_id = ?, description =?, image=?,featured=?,active=?,date_news=?");
    $sql->bind_param("sssssss", $title,$id_cate,$desc,$dst_db,$featured,$active,$date_news);
    $res=$sql->execute();
    if ($res) {
