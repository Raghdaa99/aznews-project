...
//    $sql = "update news set title = '$title', image='$dst_db', category_id='$id_cate', description='$desc',featured='$featured',
//                active='$active' where id ='$id'";
//    $edit = mysqli_query($conn, $sql);
    $sql=$conn->prepare("update news set title = ?, image=?, category_id=?, description=?,featured=?,
              active=? where id =?");
    $sql->bind_param("ssisssi",$title, $dst_db,$id_cate,$desc,$featured,$active,$id);
    $edit=$sql->execute();
    if ($edit) {
